...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cronos_station', 'elevation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Station.elevation'
        db.alter_column('cronos_station', 'elevation', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=12, decimal_places=2))
