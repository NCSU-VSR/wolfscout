...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShapeToAnalyze.shape'
        db.add_column('study_shapetoanalyze', 'shape', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShapeToAnalyze.shape'
        db.delete_column('study_shapetoanalyze', 'shape')
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 15, 40, 38, 767851)'}),
        ...
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 15, 40, 38, 769320)', 'null': 'True', 'blank': 'True'}),
