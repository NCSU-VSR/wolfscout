...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ShapeInteractionGroup'
        db.create_table('study_shapeinteractiongroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('study', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ShapeInteractionGroup', to=orm['study.Study'])),
            ('distance', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=5, blank=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('time_delta', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('dbf_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('shp_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('shx_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('prj_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('zip_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('study', ['ShapeInteractionGroup'])

        # Adding model 'ShapeInteraction'
        db.create_table('study_shapeinteraction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_shapes', self.gf('django.db.models.fields.related.ForeignKey')(related_name='AnimalSourceOfInteraction', to=orm['study.ShapeToAnalyze'])),
            ('destination_animal_data_point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ShapeAnimalDestinationOfInteraction', to=orm['gpscollar.CollarData'])),
            ('interaction_group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ShapeInteractionGrouppForInteraction', null=True, to=orm['study.AnimalInteractionGroup'])),
            ('distance', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=5)),
        ))
        db.send_create_signal('study', ['ShapeInteraction'])

        # Adding field 'AnimalInteractionGroup.start_time'
        db.add_column('study_animalinteractiongroup', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'AnimalInteractionGroup.end_time'
        db.add_column('study_animalinteractiongroup', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'AnimalInteractionGroup.time_delta'
        db.add_column('study_animalinteractiongroup', 'time_delta', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ShapeInteractionGroup'
        db.delete_table('study_shapeinteractiongroup')

        # Deleting model 'ShapeInteraction'
        db.delete_table('study_shapeinteraction')

        # Deleting field 'AnimalInteractionGroup.start_time'
        db.delete_column('study_animalinteractiongroup', 'start_time')

        # Deleting field 'AnimalInteractionGroup.end_time'
        db.delete_column('study_animalinteractiongroup', 'end_time')
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 14, 46, 19, 898327)'}),
        ...
        'study.animalinteractiongroup': {
            ...
            'time_delta': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 14, 46, 19, 901301)', 'null': 'True', 'blank': 'True'}),
