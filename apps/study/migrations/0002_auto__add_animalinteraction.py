...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AnimalInteraction'
        db.create_table('study_animalinteraction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_animal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='AnimalSourceOfInteraction', to=orm['gpscollar.CollarData'])),
            ('destination_animal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='AnimalDestinationOfInteraction', to=orm['gpscollar.CollarData'])),
            ('distance', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=5)),
        ))
        db.send_create_signal('study', ['AnimalInteraction'])


    def backwards(self, orm):
        
        # Deleting model 'AnimalInteraction'
        db.delete_table('study_animalinteraction')
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 29, 15, 46, 46, 213842)'}),
        ...
        'study.animalinteraction': {
            ...
            'destination_animal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'AnimalDestinationOfInteraction'", 'to': "orm['gpscollar.CollarData']"}),
            'distance': ('django.db.models.fields.DecimalField', [], {'max_digits': '15', 'decimal_places': '5'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source_animal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'AnimalSourceOfInteraction'", 'to': "orm['gpscollar.CollarData']"})
        },
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 29, 15, 46, 46, 215639)', 'null': 'True', 'blank': 'True'}),
