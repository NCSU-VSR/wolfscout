...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ShapeToAnalyze'
        db.create_table('study_shapetoanalyze', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shapes', self.gf('django.contrib.gis.db.models.fields.GeometryCollectionField')(null=True, blank=True)),
        ))
        db.send_create_signal('study', ['ShapeToAnalyze'])


    def backwards(self, orm):
        
        # Deleting model 'ShapeToAnalyze'
        db.delete_table('study_shapetoanalyze')
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 14, 22, 8, 54616)'}),
        ...
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 14, 22, 8, 56065)', 'null': 'True', 'blank': 'True'}),
