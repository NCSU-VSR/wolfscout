...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AnimalInteraction.source_animal'
        db.delete_column('study_animalinteraction', 'source_animal_id')

        # Deleting field 'AnimalInteraction.destination_animal'
        db.delete_column('study_animalinteraction', 'destination_animal_id')

        # Adding field 'AnimalInteraction.source_animal_data_point'
        db.add_column('study_animalinteraction', 'source_animal_data_point', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='AnimalSourceOfInteraction', to=orm['gpscollar.CollarData']), keep_default=False)

        # Adding field 'AnimalInteraction.destination_animal_data_point'
        db.add_column('study_animalinteraction', 'destination_animal_data_point', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='AnimalDestinationOfInteraction', to=orm['gpscollar.CollarData']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AnimalInteraction.source_animal'
        raise RuntimeError("Cannot reverse this migration. 'AnimalInteraction.source_animal' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AnimalInteraction.destination_animal'
        raise RuntimeError("Cannot reverse this migration. 'AnimalInteraction.destination_animal' and its values cannot be restored.")

        # Deleting field 'AnimalInteraction.source_animal_data_point'
        db.delete_column('study_animalinteraction', 'source_animal_data_point_id')

        # Deleting field 'AnimalInteraction.destination_animal_data_point'
        db.delete_column('study_animalinteraction', 'destination_animal_data_point_id')
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 29, 16, 21, 19, 914440)'}),
        ...
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 29, 16, 21, 19, 915581)', 'null': 'True', 'blank': 'True'}),
