...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ShapeToAnalyze.shapes'
        db.delete_column('study_shapetoanalyze', 'shapes')


    def backwards(self, orm):
        
        # Adding field 'ShapeToAnalyze.shapes'
        db.add_column('study_shapetoanalyze', 'shapes', self.gf('django.contrib.gis.db.models.fields.GeometryCollectionField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 15, 40, 31, 644560)'}),
        ...
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 15, 40, 31, 646065)', 'null': 'True', 'blank': 'True'}),
