...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnimalInteractionGroup.dbf_file'
        db.add_column('study_animalinteractiongroup', 'dbf_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'AnimalInteractionGroup.shp_file'
        db.add_column('study_animalinteractiongroup', 'shp_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'AnimalInteractionGroup.shx_file'
        db.add_column('study_animalinteractiongroup', 'shx_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'AnimalInteractionGroup.prj_file'
        db.add_column('study_animalinteractiongroup', 'prj_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'AnimalInteractionGroup.zip_file'
        db.add_column('study_animalinteractiongroup', 'zip_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AnimalInteractionGroup.dbf_file'
        db.delete_column('study_animalinteractiongroup', 'dbf_file')

        # Deleting field 'AnimalInteractionGroup.shp_file'
        db.delete_column('study_animalinteractiongroup', 'shp_file')

        # Deleting field 'AnimalInteractionGroup.shx_file'
        db.delete_column('study_animalinteractiongroup', 'shx_file')

        # Deleting field 'AnimalInteractionGroup.prj_file'
        db.delete_column('study_animalinteractiongroup', 'prj_file')

        # Deleting field 'AnimalInteractionGroup.zip_file'
        db.delete_column('study_animalinteractiongroup', 'zip_file')
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 10, 17, 50, 59, 845419)'}),
        ...
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 10, 17, 50, 59, 846726)', 'null': 'True', 'blank': 'True'}),
