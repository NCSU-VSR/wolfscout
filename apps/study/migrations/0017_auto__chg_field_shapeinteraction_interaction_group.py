...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShapeInteraction.interaction_group'
        db.alter_column('study_shapeinteraction', 'interaction_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['study.ShapeInteractionGroup']))


    def backwards(self, orm):
        
        # Changing field 'ShapeInteraction.interaction_group'
        db.alter_column('study_shapeinteraction', 'interaction_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['study.AnimalInteractionGroup']))
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 15, 42, 11, 959108)'}),
        ...
        'study.shapeinteraction': {
            ...
            'distance': ('django.db.models.fields.DecimalField', [], {'max_digits': '15', 'decimal_places': '5'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interaction_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ShapeInteractionGrouppForInteraction'", 'null': 'True', 'to': "orm['study.ShapeInteractionGroup']"}),
        ...
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 15, 42, 11, 960740)', 'null': 'True', 'blank': 'True'}),
