...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnimalInteractionGroup.distance'
        db.add_column('study_animalinteractiongroup', 'distance', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=5, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AnimalInteractionGroup.distance'
        db.delete_column('study_animalinteractiongroup', 'distance')
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 30, 20, 3, 36, 322430)'}),
        ...
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 30, 20, 3, 36, 324417)', 'null': 'True', 'blank': 'True'}),
