...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('study_shapeinteractiongroup', 'time_delta', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'gpscollar.collardata': {
            ...
            'DATE_ADDED': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 15, 22, 34, 692574)'}),
        ...
        'study.study': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 11, 15, 22, 34, 694064)', 'null': 'True', 'blank': 'True'}),
