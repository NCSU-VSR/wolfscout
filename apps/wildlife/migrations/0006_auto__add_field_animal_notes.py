...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Animal.notes'
        db.add_column('wildlife_animal', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Animal.notes'
        db.delete_column('wildlife_animal', 'notes')
